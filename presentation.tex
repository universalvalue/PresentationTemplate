...
\institute{Max Planck Institute for Intelligent Systems\\
	...
	\includegraphics[width=0.2\textwidth,keepaspectratio]{{images/Universität_Stuttgart_Signet}.pdf}\includegraphics[width=0.2\textwidth,keepaspectratio]{tex_supps/minerva.pdf}
      }
